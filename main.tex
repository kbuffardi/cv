...
\begin{center}
{\LARGE\bfseries Dr. Kevin Buffardi}\par
\vspace{0.25em}
{\small
\href{mailto:kbuffardi@acm.org}{kbuffardi@acm.org}
\enspace\textbar\enspace
\href{https://learnbyfailure.com}{learnbyfailure.com}
\enspace\textbar\enspace
\href{https://github.com/kbuffardi}{github.com/kbuffardi}}
\end{center}
\vspace{0.5em}

\needspace{6\baselineskip}\section*{Education}
\par \textbf{Ph.D. in Computer Science}, Virginia Tech, June 2014\par
\par Dissertation: Modeling Student Software Testing Processes: Attitudes, Behaviors, Interventions, and Their Effects\par
\par Committee: Stephen H. Edwards, Manuel Perez-Qui\~{n}ones, Eli Tilevich, Cliff Shaffer, Shelli Fowler\par
\par \textbf{M.S. in Human-Computer Interaction}, with Distinction. DePaul University\par
\par Project: Intelligent Tutoring System with Mixed-Language Interface Adviser: Peter Hastings\par
\par \textbf{B.S. in Computer Science}, Cum Laude with Honors. University of Mary Washington\par
\par Honors Paper: Algorithmically Generated Rudimentary Music Adviser: Karen Anewalt\par
\needspace{6\baselineskip}\section*{Academic Experience}
\subsection*{California State University, Chico}
\par Full Professor, 2024---Present; Associate Professor, 2019-2024; Assistant Professor, 2014-2019\par
\par California State University---Chico, Computer Science Department\par
\par \textbf{New Course Preparations:}\par
...
\end{itemize}
\par \textbf{Program Development:} Supplementary Authorizations for K-12 Computer Science Teachers\par
\par \textbf{CSED subject matter area and course designs of:}\par
\begin{itemize}[leftmargin=1.3em]
...
\par Dean's Teaching Fellow 2009---2012, Graduate Teaching Assistant 2008---2009, 2012---2013\par
\par Virginia Tech, Computer Science Department\par
\par \textbf{Instructor of Record:}\par
\begin{itemize}[leftmargin=1.3em]
...
\end{itemize}
\needspace{6\baselineskip}\section*{Industry Experience}
\par \textbf{User Experience Specialist 2006---2008, User Experience Analyst 2005---2006}\par
\par User Centric LLC, Oakbrook Terrace, Illinois\par
\begin{itemize}[leftmargin=1.3em]
\item Lead user-centered design and evaluation studies
\item Clients represent a variety of sectors including mobile tech, health care, etc.
\end{itemize}
\par \textbf{Usability Lab Intern 2004}\par
\par U.S. Census Bureau, Statistical Research Division, Suitland, Maryland\par
\begin{itemize}[leftmargin=1.3em]
...
\item Nominated: Outstanding Teaching Award (2024), Wang Excellence Award, California State University system-wide (across 23 campuses) award for excellence in teaching.
\item Outstanding Professor Award (2022-2023), California State University, Chico. \textit{University-wide award for continued excellence in research, teaching, and service.}
...
\begin{itemize}[leftmargin=1.3em]
\item NSF IUSE grant (\#2337271 \#2337270 \#2337269, Awarded: \$750,000, Co-PI, 2024---2026) Collaborative Research: FRONTIERS: Fostering Software Engineering Competence through Valid, Reliable, and Practical Assessments of Individual Contributions to Team Projects
\item CSU GI 2025 grant (Awarded: \$32,254, renewed 2020, 2021; Co-PI, 2019---2022) Engineering Math and Projects Bootcamp to Improve Retention and Graduation Rates in Engineering and Computer Science (Co-PI)
\item ECC Seed grant (Awarded: \$5,000): Emergent Technology in Tech Startup Software Engineering Projects (PI)
\item RSCA grant (Awarded: \$6,000): Formalizing the Interdisciplinary Tech Startup Model (PI)
...
\begin{itemize}[leftmargin=1.3em]
\item California Education Learning Lab (Awarded: \$50,000, PI, 2024) Python 4 All
\item National Science Foundation, BCP (\#2315883 Awarded: \$299,912, PI, 2023---2025) BPC-DP: Embedding Representation, Relevance, and Equity in a Personalized System of Instruction
\item California Education Learning Lab (Awarded: \$100,000, PI, 2020---2022) Coding Community: Inclusive Space for Programming Tutorials and Adaptive Learning
\item Department of Education American Rescue Plan Act Higher Education Emergency Relief Funds (Awarded: \$36,834, PI, 2021---2022) Coding Online Videos with Inclusive Demonstrations
...
\par Integrating research and authentic professional experiences in undergraduate courses\par
\begin{itemize}[leftmargin=1.3em]
\item NSF HSI (\#1953751 Awarded: \$2,200,001, Senior Personnel, 2020---2025) STEM Course Transformation: Cultivating a Culture of Entrepreneurial Mindset and Undergraduate Research
\begin{itemize}[leftmargin=1.5em]
...
\par Measuring the impact of software engineering students collaborating face-to-face with a community organization of software professionals on Free and Open Source Software projects.\par
\begin{itemize}[leftmargin=1.3em]
...
\par \textbf{CodeWorkout:} NSF TUES-Type I Award \#1245589\par
\begin{itemize}[leftmargin=1.3em]
\item Wrote draft of accepted NSF TUES proposal (Awarded \$321,090) and initiated development
\end{itemize}
\par CloudSpace, Student Transition Engineering Program (STEP)\par
\subsection*{Undergraduate Research Assistant, 2003}
\par NSF Research Experience for Undergraduates, UMBC, Baltimore, Maryland\par
...
\item Associate Editor PLOS One; Frontiers in ICT, section on Digital Education
\item Associate Program Chair ACM Tech. Symposium on Computer Science Education (SIGCSE)
\item ACM Innovation and Technology in Computing Education (ITiCSE), IEEE Software Engineering Education and Training (ICSE-SEET)
...
\par Research and Sponsored Programs Grant Writing Bootcamp, Summer, 2018\par
\par Hispanic Serving Institution (HSI) Faculty Learning Community, Spring, 2017\par
\par Professor's Open Source Software Experience (POSSE) Foss2Serve---\url{http://foss2serve.org/}\par
\par ---Professional development for instructors interested in student participation in Humanitarian Free and Open Source Software---\par
...
\end{itemize}
\par NSF Grant Writing Workshop, attended in Portland, Oregon, 2016\par
